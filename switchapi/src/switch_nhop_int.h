...
#define SWITCH_NHOP_ECMP_INFO(nhop) nhop->u.ecmp

#define SWITCH_NHOP_SPATH_INFO(nhop) nhop->u.spath

#define SWITCH_NHOP_TYPE_IS_ECMP(nhop) nhop->type == SWITCH_NHOP_INDEX_TYPE_ECMP
