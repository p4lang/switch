    ...
    if (group_key->sg_entry) {
      if (SWITCH_MCAST_GROUP_IP_TYPE(group_key) == SWITCH_API_IP_ADDR_V4) {
        ...
        if (vrf_entry) {
          ...
          memset(&match_spec,
                 0,
                 sizeof(p4_pd_dc_outer_ipv4_multicast_match_spec_t));
          memset(&action_spec,
                 0,
                 sizeof(p4_pd_dc_outer_multicast_route_s_g_hit_action_spec_t));

          match_spec.multicast_metadata_ipv4_mcast_key_type =
              SWITCH_MCAST_KEY_TYPE_VRF;
          match_spec.multicast_metadata_ipv4_mcast_key =
              handle_to_id(group_key->bd_vrf_handle);
          ...
          memset(&action_spec,
                 0,
                 sizeof(p4_pd_dc_outer_multicast_bridge_s_g_hit_action_spec_t));
        ...
        if (vrf_entry) {
          ...
          memset(&match_spec,
                 0,
                 sizeof(p4_pd_dc_outer_ipv6_multicast_match_spec_t));
          memset(&action_spec,
                 0,
                 sizeof(p4_pd_dc_outer_multicast_route_s_g_hit_action_spec_t));
      ...
      if (SWITCH_MCAST_GROUP_IP_TYPE(group_key) == SWITCH_API_IP_ADDR_V4) {
        ...
        if (vrf_entry) {
          if (mc_mode == SWITCH_API_MCAST_IPMC_PIM_SM) {
            ...
            memset(&match_spec,
                   0,
                   sizeof(p4_pd_dc_outer_ipv4_multicast_star_g_match_spec_t));
            memset(
                &action_spec,
                0,
                sizeof(
          ...
          memset(
              &action_spec,
              0,
              sizeof(p4_pd_dc_outer_multicast_bridge_star_g_hit_action_spec_t));
        ...
        if (vrf_entry) {
          if (mc_mode == SWITCH_API_MCAST_IPMC_PIM_SM) {
            ...
            memset(&match_spec,
                   0,
                   sizeof(p4_pd_dc_outer_ipv6_multicast_star_g_match_spec_t));
            memset(
                &action_spec,
                0,
                sizeof(
  ...
  if (group_key->sg_entry) {
    if (SWITCH_MCAST_GROUP_IP_TYPE(group_key) == SWITCH_API_IP_ADDR_V4) {
      ...
      if (vrf_entry) {
        ...
        memset(
            &match_spec, 0, sizeof(p4_pd_dc_ipv4_multicast_route_match_spec_t));
        ...
        memset(&action_spec,
               0,
               sizeof(p4_pd_dc_multicast_route_s_g_hit_action_spec_t));
        action_spec.action_mc_index = mgid_index;
        action_spec.action_mcast_rpf_group = rpf_group;
        ...
        memset(&match_spec,
               0,
               sizeof(p4_pd_dc_ipv4_multicast_bridge_match_spec_t));
        ...
        memset(&action_spec,
               0,
               sizeof(p4_pd_dc_multicast_bridge_s_g_hit_action_spec_t));
        action_spec.action_mc_index = mgid_index;
      ...
      if (vrf_entry) {
        ...
        memset(
            &match_spec, 0, sizeof(p4_pd_dc_ipv6_multicast_route_match_spec_t));
        match_spec.l3_metadata_vrf = handle_to_id(group_key->bd_vrf_handle);
        ...
        memset(&match_spec,
               0,
               sizeof(p4_pd_dc_ipv6_multicast_bridge_match_spec_t));
        match_spec.ingress_metadata_bd = handle_to_id(group_key->bd_vrf_handle);
        memcpy(&(match_spec.ipv6_metadata_lkp_ipv6_sa),
               &(SWITCH_MCAST_GROUP_IPV6_SRC_IP(group_key)),
               16);
    ...
    if (SWITCH_MCAST_GROUP_IP_TYPE(group_key) == SWITCH_API_IP_ADDR_V4) {
      ...
      if (vrf_entry) {
        ...
        if (mc_mode == SWITCH_API_MCAST_IPMC_PIM_SM) {
          ...
          memset(&match_spec,
                 0,
                 sizeof(p4_pd_dc_ipv4_multicast_route_star_g_match_spec_t));
          match_spec.l3_metadata_vrf = handle_to_id(group_key->bd_vrf_handle);
          match_spec.ipv4_metadata_lkp_ipv4_da =
              SWITCH_MCAST_GROUP_IPV4_GRP_IP(group_key);
          ...
          memset(&action_spec,
                 0,
                 sizeof(p4_pd_dc_multicast_route_sm_star_g_hit_action_spec_t));
          action_spec.action_mc_index = mgid_index;
          action_spec.action_mcast_rpf_group = rpf_group;
          ...
          memset(
              &action_spec,
              0,
              sizeof(p4_pd_dc_multicast_route_bidir_star_g_hit_action_spec_t));
          action_spec.action_mc_index = mgid_index;
          action_spec.action_mcast_rpf_group = rpf_group;
        ...
        memset(&match_spec,
               0,
               sizeof(p4_pd_dc_ipv4_multicast_bridge_star_g_match_spec_t));
        match_spec.ingress_metadata_bd = handle_to_id(group_key->bd_vrf_handle);
        match_spec.ipv4_metadata_lkp_ipv4_da =
            SWITCH_MCAST_GROUP_IPV4_GRP_IP(group_key);
        ...
        memset(&action_spec,
               0,
               sizeof(p4_pd_dc_multicast_bridge_star_g_hit_action_spec_t));
        action_spec.action_mc_index = mgid_index;
      ...
      if (vrf_entry) {
        ...
        if (mc_mode == SWITCH_API_MCAST_IPMC_PIM_SM) {
          ...
          memset(&match_spec,
                 0,
                 sizeof(p4_pd_dc_ipv6_multicast_route_star_g_match_spec_t));
          match_spec.l3_metadata_vrf = handle_to_id(group_key->bd_vrf_handle);
          memcpy(&(match_spec.ipv6_metadata_lkp_ipv6_da),
                 &(SWITCH_MCAST_GROUP_IPV6_GRP_IP(group_key)),
                 16);
        ...
        memset(&match_spec,
               0,
               sizeof(p4_pd_dc_ipv6_multicast_bridge_star_g_match_spec_t));
        match_spec.ingress_metadata_bd = handle_to_id(group_key->bd_vrf_handle);
        memcpy(&(match_spec.ipv6_metadata_lkp_ipv6_da),
               &(SWITCH_MCAST_GROUP_IPV6_GRP_IP(group_key)),
               16);
