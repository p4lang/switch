...
p4_pd_status_t switch_pd_client_init(switch_device_t device) {
  ...
  status = p4_pd_mc_create_session(&g_mc_sess_hdl);
  if (status) return status;
#endif
  return p4_pd_client_init(&g_sess_hdl);
}
...
p4_pd_status_t switch_pd_dmac_table_add_entry(
  ...
  if (mac_entry->mac_action == SWITCH_MAC_ACTION_FORWARD) {
    if (mgid_index) {
      ...
      memset(
          &action_spec, 0, sizeof(p4_pd_dc_dmac_multicast_hit_action_spec_t));
...
p4_pd_status_t switch_pd_dmac_table_update_entry(
  ...
  if (mgid_index) {
    ...
    action_spec.action_mc_index = mgid_index;
    status = p4_pd_dc_dmac_table_modify_with_dmac_multicast_hit(
    ...
    switch (SWITCH_INTF_TYPE(intf_info)) {
      ...
      case SWITCH_API_INTERFACE_L2_VLAN_TRUNK: {
        ...
        memset(&hit_action_spec, 0, sizeof(p4_pd_dc_dmac_hit_action_spec_t));
        hit_action_spec.action_ifindex = intf_info->ifindex;
        status = p4_pd_dc_dmac_table_modify_with_dmac_hit(
            g_sess_hdl, device, entry_hdl, &hit_action_spec);
      } break;
      case SWITCH_API_INTERFACE_TUNNEL: {
        p4_pd_dc_dmac_redirect_nexthop_action_spec_t nhop_action_spec;
        memset(&nhop_action_spec,
               ...
               sizeof(p4_pd_dc_dmac_redirect_nexthop_action_spec_t));
        nhop_action_spec.action_nexthop_index = nhop_index;
        status = p4_pd_dc_dmac_table_modify_with_dmac_redirect_nexthop(
            g_sess_hdl, device, entry_hdl, &nhop_action_spec);
      } break;
      default:
        status = SWITCH_STATUS_INVALID_INTERFACE;
    }
...
p4_pd_status_t switch_pd_dmac_table_delete_entry(switch_device_t device,
  ...
  status = p4_pd_dc_dmac_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_L2_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_smac_table_update_entry(
  ...
  status = p4_pd_dc_smac_table_modify_with_smac_hit(
      g_sess_hdl, device, entry_hdl, &action_spec);
#endif /* P4_L2_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_smac_table_delete_entry(switch_device_t device,
  ...
  status = p4_pd_dc_smac_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_L2_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_nexthop_table_add_entry(switch_device_t device,
  ...
  if (flood) {
    ...
    status = p4_pd_dc_nexthop_table_add_with_set_nexthop_details(
        g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
  }
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_nexthop_table_update_entry(
  ...
  if (flood) {
    ...
    action_spec.action_ifindex = ifindex;
    action_spec.action_tunnel = tunnel;
    status = p4_pd_dc_nexthop_table_modify_with_set_nexthop_details(
        g_sess_hdl, device, *entry_hdl, &action_spec);
  }
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_ecmp_group_create(switch_device_t device,
  ...
  status = p4_pd_dc_ecmp_action_profile_create_group(
      g_sess_hdl, p4_pd_device, MAX_ECMP_GROUP_SIZE, pd_group_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_ecmp_group_delete(switch_device_t device,
  ...
  switch_status_t status = 0;
  status =
      p4_pd_dc_ecmp_action_profile_del_group(g_sess_hdl, device, pd_group_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_ecmp_member_add(switch_device_t device,
  ...
  memset(
      &action_spec, 0, sizeof(p4_pd_dc_set_ecmp_nexthop_details_action_spec_t));
  ...
  status =
      p4_pd_dc_ecmp_action_profile_add_member_with_set_ecmp_nexthop_details(
          g_sess_hdl, pd_device, &action_spec, mbr_hdl);

  status = p4_pd_dc_ecmp_action_profile_add_member_to_group(
      g_sess_hdl, device, pd_group_hdl, *mbr_hdl);
...
p4_pd_status_t switch_pd_ecmp_group_table_delete_entry(
  ...
  p4_pd_status_t status = 0;
  status = p4_pd_dc_ecmp_group_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_ecmp_group_table_add_entry_with_selector(
  ...
  status = p4_pd_dc_ecmp_group_add_entry_with_selector(
      g_sess_hdl, pd_device, &match_spec, grp_hdl, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}

p4_pd_status_t p4_pd_ecmp_group_table_delete_entry(
    switch_device_t device, p4_pd_entry_hdl_t entry_hdl) {
  p4_pd_status_t status = 0;
  status = p4_pd_dc_ecmp_group_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_nexthop_table_delete_entry(
  ...
  status = p4_pd_dc_nexthop_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
  ...
  if (ip_addr->type == SWITCH_API_IP_ADDR_V4) {
    ...
    if (ecmp) {
      if (host_entry) {
        ...
        v4_action_spec.action_ecmp_index = nexthop;
        status =
            p4_pd_dc_ipv4_fib_lpm_table_add_with_fib_hit_ecmp(g_sess_hdl,
                                                              p4_pd_device,
                                                              &v4_match_spec,
                                                              &v4_action_spec,
                                                              entry_hdl);
      ...
      if (host_entry) {
        ...
        status =
            p4_pd_dc_ipv4_fib_table_add_with_fib_hit_nexthop(g_sess_hdl,
                                                             p4_pd_device,
                                                             &v4_match_spec,
                                                             &v4_action_spec,
                                                             entry_hdl);
        ...
        v4_match_spec.ipv4_metadata_lkp_ipv4_da_prefix_length =
            ip_addr->prefix_len;
        v4_action_spec.action_nexthop_index = nexthop;
        status = p4_pd_dc_ipv4_fib_lpm_table_add_with_fib_hit_nexthop(
            g_sess_hdl,
            p4_pd_device,
            &v4_match_spec,
            &v4_action_spec,
    ...
    if (ecmp) {
      if (host_entry) {
        ...
        memcpy(
            &v6_match_spec.ipv6_metadata_lkp_ipv6_da, ip_addr->ip.v6addr, 16);
        ...
        v6_action_spec.action_ecmp_index = nexthop;
        status =
            p4_pd_dc_ipv6_fib_lpm_table_add_with_fib_hit_ecmp(g_sess_hdl,
                                                              p4_pd_device,
                                                              &v6_match_spec,
                                                              &v6_action_spec,
                                                              entry_hdl);
      ...
      if (host_entry) {
        ...
        memset(&v6_match_spec, 0, sizeof(p4_pd_dc_ipv6_fib_match_spec_t));
        memset(
            &v6_action_spec, 0, sizeof(p4_pd_dc_fib_hit_nexthop_action_spec_t));
        ...
        status =
            p4_pd_dc_ipv6_fib_table_add_with_fib_hit_nexthop(g_sess_hdl,
                                                             p4_pd_device,
                                                             &v6_match_spec,
                                                             &v6_action_spec,
                                                             entry_hdl);
        ...
        v6_match_spec.ipv6_metadata_lkp_ipv6_da_prefix_length =
            ip_addr->prefix_len;
        v6_action_spec.action_nexthop_index = nexthop;
        status = p4_pd_dc_ipv6_fib_lpm_table_add_with_fib_hit_nexthop(
            g_sess_hdl,
            p4_pd_device,
            &v6_match_spec,
            &v6_action_spec,
  ...
  if (ip_addr->type == SWITCH_API_IP_ADDR_V4) {
    ...
    if (ecmp) {
      if (host_entry) {
        ...
        memset(&v4_action_spec, 0, sizeof(p4_pd_dc_fib_hit_ecmp_action_spec_t));
        v4_action_spec.action_ecmp_index = nexthop;
        status = p4_pd_dc_ipv4_fib_table_modify_with_fib_hit_ecmp(
            g_sess_hdl, device, entry_hdl, &v4_action_spec);
      } else {
        p4_pd_dc_fib_hit_ecmp_action_spec_t v4_action_spec;
        memset(&v4_action_spec, 0, sizeof(p4_pd_dc_fib_hit_ecmp_action_spec_t));
        v4_action_spec.action_ecmp_index = nexthop;
        status = p4_pd_dc_ipv4_fib_lpm_table_modify_with_fib_hit_ecmp(
            g_sess_hdl, device, entry_hdl, &v4_action_spec);
      }
    } else {
      if (host_entry) {
        ...
        memset(
            &v4_action_spec, 0, sizeof(p4_pd_dc_fib_hit_nexthop_action_spec_t));
        v4_action_spec.action_nexthop_index = nexthop;
        status = p4_pd_dc_ipv4_fib_table_modify_with_fib_hit_nexthop(
            g_sess_hdl, device, entry_hdl, &v4_action_spec);
      } else {
        p4_pd_dc_fib_hit_nexthop_action_spec_t v4_action_spec;
        memset(
            &v4_action_spec, 0, sizeof(p4_pd_dc_fib_hit_nexthop_action_spec_t));
        v4_action_spec.action_nexthop_index = nexthop;
        status = p4_pd_dc_ipv4_fib_lpm_table_modify_with_fib_hit_nexthop(
            g_sess_hdl, device, entry_hdl, &v4_action_spec);
      }
    }
#endif /* P4_IPV4_DISABLE */
    ...
    if (ecmp) {
      if (host_entry) {
        ...
        memset(&v6_action_spec, 0, sizeof(p4_pd_dc_fib_hit_ecmp_action_spec_t));
        v6_action_spec.action_ecmp_index = nexthop;
        status = p4_pd_dc_ipv6_fib_table_modify_with_fib_hit_ecmp(
            g_sess_hdl, device, entry_hdl, &v6_action_spec);
      } else {
        p4_pd_dc_fib_hit_ecmp_action_spec_t v6_action_spec;
        memset(&v6_action_spec, 0, sizeof(p4_pd_dc_fib_hit_ecmp_action_spec_t));
        v6_action_spec.action_ecmp_index = nexthop;
        status = p4_pd_dc_ipv6_fib_lpm_table_modify_with_fib_hit_ecmp(
            g_sess_hdl, device, entry_hdl, &v6_action_spec);
      }
    } else {
      if (host_entry) {
        ...
        memset(
            &v6_action_spec, 0, sizeof(p4_pd_dc_fib_hit_nexthop_action_spec_t));
        v6_action_spec.action_nexthop_index = nexthop;
        status = p4_pd_dc_ipv6_fib_table_modify_with_fib_hit_nexthop(
            g_sess_hdl, device, entry_hdl, &v6_action_spec);
      } else {
        p4_pd_dc_fib_hit_nexthop_action_spec_t v6_action_spec;
        memset(
            &v6_action_spec, 0, sizeof(p4_pd_dc_fib_hit_nexthop_action_spec_t));
        v6_action_spec.action_nexthop_index = nexthop;
        status = p4_pd_dc_ipv6_fib_lpm_table_modify_with_fib_hit_nexthop(
            g_sess_hdl, device, entry_hdl, &v6_action_spec);
      }
    }
#endif /* P4_IPV6_DISABLE */
...
p4_pd_status_t switch_pd_ip_fib_delete_entry(switch_device_t device,
  ...
  if (ip_addr->type == SWITCH_API_IP_ADDR_V4) {
    ...
    host_entry =
        ip_addr->prefix_len == SWITCH_IPV4_PREFIX_LENGTH ? TRUE : FALSE;
    if (host_entry) {
      status = p4_pd_dc_ipv4_fib_table_delete(g_sess_hdl, device, entry_hdl);
    } else {
      status =
          p4_pd_dc_ipv4_fib_lpm_table_delete(g_sess_hdl, device, entry_hdl);
    }
#endif /* IPV4_DISABLE */
  } else {
#ifndef P4_IPV6_DISABLE
    host_entry =
        ip_addr->prefix_len == SWITCH_IPV6_PREFIX_LENGTH ? TRUE : FALSE;
    if (host_entry) {
      status = p4_pd_dc_ipv6_fib_table_delete(g_sess_hdl, device, entry_hdl);
    } else {
      status =
          p4_pd_dc_ipv6_fib_lpm_table_delete(g_sess_hdl, device, entry_hdl);
    }
#endif /* P4_IPV6_DISABLE */
  }
#endif /* L3_DISABLE */
...
p4_pd_status_t switch_pd_inner_rmac_table_add_entry(
  ...
  status = p4_pd_dc_rmac_table_add_with_rmac_hit(
...
p4_pd_status_t switch_pd_inner_rmac_table_delete_entry(
  ...
  status = p4_pd_dc_rmac_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_outer_rmac_table_delete_entry(
  ...
  status = p4_pd_dc_outer_rmac_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_TUNNEL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}

p4_pd_status_t switch_pd_src_vtep_table_add_entry(
    switch_device_t device,
  ...
  if (SWITCH_IP_ENCAP_SRC_IP_TYPE(ip_encap) == SWITCH_API_IP_ADDR_V4) {
    ...
    status = p4_pd_dc_ipv4_src_vtep_table_add_with_src_vtep_hit(
        g_sess_hdl, p4_pd_device, &v4_match_spec, &v4_action_spec, entry_hdl);
#endif /* P4_IPV4_DISABLE */
  } else {
#ifndef P4_IPV6_DISABLE
    ...
    status = p4_pd_dc_ipv6_src_vtep_table_add_with_src_vtep_hit(
        g_sess_hdl, p4_pd_device, &v6_match_spec, &v6_action_spec, entry_hdl);
#endif /* P4_IPV6_DISABLE */
  }
...
p4_pd_status_t switch_pd_src_vtep_table_delete_entry(
  ...
  if (SWITCH_IP_ENCAP_SRC_IP_TYPE(ip_encap) == SWITCH_API_IP_ADDR_V4) {
#ifndef P4_IPV4_DISABLE
    status = p4_pd_dc_ipv4_src_vtep_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_IPV4_DISABLE */
  } else {
#ifndef P4_IPV6_DISABLE
    status = p4_pd_dc_ipv6_src_vtep_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_IPV6_DISABLE */
  }
#endif /* P4_TUNNEL_DISABLE && P4_L3_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_dest_vtep_table_add_entry(
  ...
  if (SWITCH_IP_ENCAP_DST_IP_TYPE(ip_encap) == SWITCH_API_IP_ADDR_V4) {
    ...
    status = p4_pd_dc_ipv4_dest_vtep_table_add_with_set_tunnel_termination_flag(
        g_sess_hdl, p4_pd_device, &v4_match_spec, entry_hdl);
#endif /* P4_IPV4_DISABLE */
  } else {
#ifndef P4_IPV6_DISABLE
    ...
    status = p4_pd_dc_ipv6_dest_vtep_table_add_with_set_tunnel_termination_flag(
        g_sess_hdl, p4_pd_device, &v6_match_spec, entry_hdl);
#endif /* P4_IPV6_DISABLE */
  }
#endif /* P4_TUNNEL_DISABLE && P4_L3_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
#ifndef P4_IPV4_DISABLE
    status =
        p4_pd_dc_ipv4_dest_vtep_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_IPV4_DISABLE */
  } else {
#ifndef P4_IPV6_DISABLE
    status =
        p4_pd_dc_ipv6_dest_vtep_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_IPV6_DISABLE */
  }
#endif /* P4_TUNNEL_DISABLE && P4_L3_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_tunnel_smac_rewrite_table_add_entry(
    ...
    p4_pd_entry_hdl_t *entry_hdl) {
  p4_pd_status_t status = 0;
#if !defined(P4_TUNNEL_DISABLE) || !defined(P4_MIRROR_DISABLE)
  p4_pd_dev_target_t p4_pd_device;
  ...
  status = p4_pd_dc_tunnel_smac_rewrite_table_add_with_rewrite_tunnel_smac(
      g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
...
#if !defined(P4_TUNNEL_DISABLE) || !defined(P4_MIRROR_DISABLE)
  status =
      p4_pd_dc_tunnel_smac_rewrite_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_tunnel_dmac_rewrite_table_add_entry(
  ...
  status = p4_pd_dc_tunnel_dmac_rewrite_table_add_with_rewrite_tunnel_dmac(
      g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
#if !defined(P4_TUNNEL_DISABLE) || !defined(P4_MIRROR_DISABLE)
  status =
      p4_pd_dc_tunnel_dmac_rewrite_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_tunnel_rewrite_table_add_entry(
  ...
  memset(&action_spec,
         0,
         sizeof(p4_pd_dc_set_tunnel_rewrite_details_action_spec_t));
...
p4_pd_status_t switch_pd_tunnel_rewrite_table_delete_entry(
  ...
  p4_pd_status_t status = 0;
#if !defined(P4_TUNNEL_DISABLE) || !defined(P4_MIRROR_DISABLE)
  status = p4_pd_dc_tunnel_rewrite_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_tunnel_table_add_entry(switch_device_t device,
  ...
  switch (encap_type) {
    ...
    case SWITCH_API_ENCAP_TYPE_ERSPAN_T3:
      ...
      break;
    case SWITCH_API_ENCAP_TYPE_IPIP:
      ingress_tunnel_type = SWITCH_INGRESS_TUNNEL_TYPE_IPIP;
      break;
    default:
  ...
  if ((ingress_tunnel_type == SWITCH_INGRESS_TUNNEL_TYPE_VXLAN) ||
    ...
    v4_action_spec.action_ipv4_unicast_enabled =
        SWITCH_LN_IPV4_UNICAST_ENABLED(bd_info);
    v4_action_spec.action_ipv4_multicast_enabled =
        SWITCH_LN_IPV4_MULTICAST_ENABLED(bd_info);
    v4_action_spec.action_igmp_snooping_enabled =
    ...
    v6_action_spec.action_ipv6_unicast_enabled =
        SWITCH_LN_IPV4_UNICAST_ENABLED(bd_info);
    v6_action_spec.action_ipv6_multicast_enabled =
        SWITCH_LN_IPV4_MULTICAST_ENABLED(bd_info);
    v6_action_spec.action_mld_snooping_enabled =
...
p4_pd_status_t switch_pd_tunnel_table_delete_entry(
  ...
  for (entry = 0; entry < 3; entry++) {
    if (entry_hdl[entry]) {
      status =
          p4_pd_dc_tunnel_table_delete(g_sess_hdl, device, entry_hdl[entry]);
    }
  }
  p4_pd_complete_operations(g_sess_hdl);
#endif /* P4_TUNNEL_DISABLE */
...
p4_pd_status_t switch_pd_egress_vni_table_add_entry(
  ...
  status = p4_pd_dc_egress_vni_table_add_with_set_egress_tunnel_vni(
      g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
#endif /* P4_TUNNEL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_egress_vni_table_delete_entry(
  ...
  status = p4_pd_dc_egress_vni_table_delete(g_sess_hdl, device_id, entry_hdl);
#endif /* P4_TUNNEL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}

p4_pd_status_t switch_pd_tunnel_decap_tables_init_entry(
    switch_device_t device) {
  p4_pd_status_t status = 0;
  ...
  status = p4_pd_dc_tunnel_decap_process_inner_table_add_with_decap_inner_tcp(
      g_sess_hdl, p4_pd_device, &i_match_spec, &entry_hdl);
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_decap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_ingress_tunnel_type =
      SWITCH_INGRESS_TUNNEL_TYPE_GENEVE;
  o_match_spec.inner_ipv4_valid = TRUE;
  status =
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_decap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_ingress_tunnel_type =
      SWITCH_INGRESS_TUNNEL_TYPE_GRE;
  o_match_spec.inner_ipv4_valid = TRUE;
  status =
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_decap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_ingress_tunnel_type =
      SWITCH_INGRESS_TUNNEL_TYPE_IPIP;
  o_match_spec.inner_ipv4_valid = TRUE;
  status =
...
p4_pd_status_t switch_pd_tunnel_encap_tables_init_entry(
    switch_device_t device) {
  p4_pd_status_t status = 0;
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV6_VXLAN;
  o_match_spec.multicast_metadata_replica = false;
  status =
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV4_GENEVE;
  o_match_spec.multicast_metadata_replica = false;
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV6_NVGRE;
  o_match_spec.multicast_metadata_replica = false;
  status =
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV4_GRE;
  o_match_spec.multicast_metadata_replica = false;
  status = p4_pd_dc_tunnel_encap_process_outer_table_add_with_ipv4_gre_rewrite(
      g_sess_hdl, p4_pd_device, &o_match_spec, &entry_hdl);
  memset(&o_match_spec,
         0,
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  ...
  o_match_spec.multicast_metadata_replica = false;
  status = p4_pd_dc_tunnel_encap_process_outer_table_add_with_ipv6_gre_rewrite(
      g_sess_hdl, p4_pd_device, &o_match_spec, &entry_hdl);
  memset(&o_match_spec,
         0,
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV4_IP;
  o_match_spec.multicast_metadata_replica = false;
  status = p4_pd_dc_tunnel_encap_process_outer_table_add_with_ipv4_ip_rewrite(
      g_sess_hdl, p4_pd_device, &o_match_spec, &entry_hdl);
  memset(&o_match_spec,
         0,
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV6_IP;
  o_match_spec.multicast_metadata_replica = false;
  status = p4_pd_dc_tunnel_encap_process_outer_table_add_with_ipv6_ip_rewrite(
      g_sess_hdl, p4_pd_device, &o_match_spec, &entry_hdl);
  memset(&o_match_spec,
         0,
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_MPLS_L2VPN;
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_MPLS_L3VPN;
  o_match_spec.tunnel_metadata_egress_header_count = 1;
  o_match_spec.multicast_metadata_replica = false;
  status =
  ...
  memset(&o_match_spec,
         ...
         sizeof(p4_pd_dc_tunnel_encap_process_outer_match_spec_t));
  o_match_spec.tunnel_metadata_egress_tunnel_type =
      SWITCH_EGRESS_TUNNEL_TYPE_IPV4_ERSPAN_T3;
  o_match_spec.multicast_metadata_replica = false;
  status =
...
p4_pd_status_t switch_pd_rewrite_table_fabric_add_entry(
  ...
  switch (tunnel_type) {
    case SWITCH_EGRESS_TUNNEL_TYPE_CPU:
      ...
      status =
          p4_pd_dc_tunnel_encap_process_outer_table_add_with_fabric_rewrite(
              g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
      break;
    default:
      break;
...
p4_pd_status_t switch_pd_tunnel_src_rewrite_table_add_entry(
  ...
  if (SWITCH_IP_ENCAP_SRC_IP_TYPE(ip_encap) == SWITCH_API_IP_ADDR_V4) {
    ...
    memset(&v4_action_spec,
           0,
           sizeof(p4_pd_dc_rewrite_tunnel_ipv4_src_action_spec_t));
    ...
    memset(&v6_action_spec,
           0,
           sizeof(p4_pd_dc_rewrite_tunnel_ipv6_src_action_spec_t));
    v6_match_spec.tunnel_metadata_tunnel_src_index = tunnel_src_index;
    memcpy(
        &v6_action_spec.action_ip, SWITCH_IP_ENCAP_IPV6_SRC_IP(ip_encap), 16);
...
#if !defined(P4_TUNNEL_DISABLE) || !defined(P4_MIRROR_DISABLE)
  status =
      p4_pd_dc_tunnel_src_rewrite_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_tunnel_dst_rewrite_table_add_entry(
  ...
  if (SWITCH_IP_ENCAP_DST_IP_TYPE(ip_encap) == SWITCH_API_IP_ADDR_V4) {
    ...
    memcpy(
        &v6_action_spec.action_ip, SWITCH_IP_ENCAP_IPV6_DST_IP(ip_encap), 16);
...
#if !defined(P4_TUNNEL_DISABLE) || !defined(P4_MIRROR_DISABLE)
  status =
      p4_pd_dc_tunnel_dst_rewrite_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_bd_table_add_entry(switch_device_t device,
  ...
  if (status != SWITCH_STATUS_SUCCESS) {
    SWITCH_API_ERROR("bd member add failed");
    return status;
  }
  ...
  status = p4_pd_dc_bd_flood_table_add_with_set_bd_flood_mc_index(
      ...
      &bd_info->uuc_entry);
  if (status != SWITCH_STATUS_SUCCESS) {
    SWITCH_API_ERROR("bd flood uuc add failed");
    p4_pd_dc_bd_action_profile_del_member(
        g_sess_hdl, device, bd_info->bd_entry);
    return status;
  }
...
#ifndef P4_MULTICAST_DISABLE
    p4_pd_dc_bd_flood_table_delete(g_sess_hdl, device, bd_info->uuc_entry);
#endif
    return status;
  }
...
#ifndef P4_MULTICAST_DISABLE
    p4_pd_dc_bd_flood_table_delete(g_sess_hdl, device, bd_info->uuc_entry);
    p4_pd_dc_bd_flood_table_delete(g_sess_hdl, device, bd_info->umc_entry);
#endif
  ...
  if (status != SWITCH_STATUS_SUCCESS) {
    ...
    p4_pd_dc_bd_flood_table_delete(g_sess_hdl, device, bd_info->uuc_entry);
    p4_pd_dc_bd_flood_table_delete(g_sess_hdl, device, bd_info->umc_entry);
    p4_pd_dc_bd_flood_table_delete(g_sess_hdl, device, bd_info->bcast_entry);
#endif
  }
...
p4_pd_status_t switch_pd_bd_table_delete_entry(switch_device_t device,
  ...
  status = p4_pd_dc_port_vlan_mapping_table_delete(
      g_sess_hdl, device, bd_info->cpu_entry);

  status = p4_pd_dc_bd_action_profile_del_member(
      g_sess_hdl, device, bd_info->bd_entry);
...
p4_pd_status_t switch_pd_egress_bd_map_table_add_entry(
  ...
  action_spec.action_nat_mode = SWITCH_LN_NAT_MODE(bd_info);
  action_spec.action_bd_label = handle_to_id(bd_info->ln_info.bd_label);
...
p4_pd_status_t switch_pd_egress_bd_map_table_delete_entry(
  ...
  status = p4_pd_dc_egress_bd_map_table_delete(
      g_sess_hdl, device, bd_info->egress_bd_entry);
...
p4_pd_status_t switch_pd_egress_bd_stats_table_add_entry(
  ...
  status = p4_pd_dc_egress_bd_stats_table_add_with_nop(
      g_sess_hdl, p4_pd_device, &match_spec, &entry_hdl[index++]);
...
p4_pd_status_t switch_pd_egress_bd_stats_table_delete_entry(
  ...
  status = p4_pd_dc_egress_bd_stats_table_delete(
      g_sess_hdl, device, entry_hdl[index++]);
...
p4_pd_status_t switch_pd_port_vlan_mapping_table_delete_entry(
  ...
  status =
      p4_pd_dc_port_vlan_mapping_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_egress_vlan_xlate_table_add_entry(
  ...
  memset(&action_spec,
         0,
         sizeof(p4_pd_dc_set_egress_packet_vlan_tagged_action_spec_t));
  ...
  if (vlan_id != 0) {
    ...
    status =
        p4_pd_dc_egress_vlan_xlate_table_add_with_set_egress_packet_vlan_tagged(
            g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
  } else {
    status =
        p4_pd_dc_egress_vlan_xlate_table_add_with_set_egress_packet_vlan_untagged(
            g_sess_hdl, p4_pd_device, &match_spec, entry_hdl);
  }
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_egress_vlan_xlate_table_delete_entry(
  ...
  p4_pd_status_t status = 0;
  status =
      p4_pd_dc_egress_vlan_xlate_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_ingress_port_mapping_table_add_entry(
  ...
  match1_spec.standard_metadata_ingress_port = SWITCH_PORT_ID(port_info);
  ...
  action2_spec.action_trust_dscp = port_info->trust_dscp;
  action2_spec.action_trust_pcp = port_info->trust_pcp;

  modify = (port_info->hw_entry[0] != SWITCH_HW_INVALID_HANDLE) ? TRUE : FALSE;
  if (modify) {
    status = p4_pd_dc_ingress_port_mapping_table_modify_with_set_ifindex(
        g_sess_hdl, 0, port_info->hw_entry[0], &action1_spec);
    status =
        p4_pd_dc_ingress_port_properties_table_modify_with_set_ingress_port_properties(
            g_sess_hdl, 0, port_info->hw_entry[1], &action2_spec);
  } else {
...
p4_pd_status_t switch_pd_egress_port_mapping_table_delete_entry(
  ...
  status =
      p4_pd_dc_egress_port_mapping_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_rewrite_table_tunnel_rewrite_add_entry(
  ...
  switch (encap_type) {
    ...
    case SWITCH_API_ENCAP_TYPE_IPIP:
      if (neigh_type == SWITCH_API_NEIGHBOR_IPV4_TUNNEL) {
        ...
        tunnel_type = SWITCH_EGRESS_TUNNEL_TYPE_IPV6_IP;
      }
      break;
    case SWITCH_API_ENCAP_TYPE_GRE:
      if (neigh_type == SWITCH_API_NEIGHBOR_IPV4_TUNNEL) {
        ...
        tunnel_type = SWITCH_EGRESS_TUNNEL_TYPE_IPV6_GRE;
      }
      break;
    default:
  ...
  if (rw_type == SWITCH_API_NEIGHBOR_RW_TYPE_L2) {
    ...
    action_spec.action_tunnel_index = tunnel_index;
    status = p4_pd_dc_rewrite_table_add_with_set_l2_rewrite_with_tunnel(
        g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
  } else {
#ifndef P4_L3_DISABLE
...
p4_pd_status_t switch_pd_rewrite_table_tunnel_rewrite_update_entry(
  ...
  if (rw_type == SWITCH_API_NEIGHBOR_RW_TYPE_L2) {
    ...
    action_spec.action_tunnel_type = tunnel_type;
    action_spec.action_tunnel_index = tunnel_index;
    status = p4_pd_dc_rewrite_table_modify_with_set_l2_rewrite_with_tunnel(
        g_sess_hdl, device, entry_hdl, &action_spec);
  } else {
#ifndef P4_L3_DISABLE
    p4_pd_dc_set_l3_rewrite_with_tunnel_action_spec_t action_spec;
...
p4_pd_status_t switch_pd_lag_group_create(switch_device_t device,
  ...
  status = p4_pd_dc_lag_action_profile_create_group(
      g_sess_hdl, pd_device, MAX_LAG_GROUP_SIZE, pd_group_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_lag_group_delete(switch_device_t device,
  ...
  status =
      p4_pd_dc_lag_action_profile_del_group(g_sess_hdl, device, pd_group_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_lag_group_table_add_entry(
  ...
  if (modify) {
    ...
    status = p4_pd_dc_lag_action_profile_add_member_with_set_lag_port(
        g_sess_hdl, pd_device, &action_spec, mbr_hdl);
    status = p4_pd_dc_lag_group_add_entry(
        g_sess_hdl, pd_device, &lg_match_spec, *mbr_hdl, entry_hdl);
  }
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_lag_group_table_add_entry_with_selector(
  ...
  if (modify) {
    ...
    status = p4_pd_dc_lag_group_add_entry_with_selector(
        g_sess_hdl, pd_device, &lg_match_spec, pd_group_hdl, entry_hdl);
  }
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_lag_group_table_delete_entry(
    switch_device_t device, p4_pd_entry_hdl_t entry_hdl) {
  p4_pd_status_t status = 0;
  status = p4_pd_dc_lag_group_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_smac_rewrite_table_delete_entry(
  ...
  p4_pd_status_t status = 0;
#ifndef P4_L3_DISABLE
  status = p4_pd_dc_smac_rewrite_table_delete(
      g_sess_hdl, device, smac_entry->hw_smac_entry);
#endif /* P4_L3_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_rid_table_add_entry(switch_device_t device,
  ...
  if (!inner_replica) {
    ...
    memset(
        &action_spec, 0, sizeof(p4_pd_dc_outer_replica_from_rid_action_spec_t));
    action_spec.action_bd = bd;
    action_spec.action_tunnel_type = tunnel_type;
    action_spec.action_tunnel_index = tunnel_index;
    ...
    memset(
        &action_spec, 0, sizeof(p4_pd_dc_inner_replica_from_rid_action_spec_t));
    action_spec.action_bd = bd;
    action_spec.action_tunnel_type = tunnel_type;
    action_spec.action_tunnel_index = tunnel_index;
...
p4_pd_status_t switch_pd_rid_table_delete_entry(switch_device_t device,
  ...
  status = p4_pd_dc_rid_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_MULTICAST_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_spanning_tree_table_add_entry(
  ...
  status = p4_pd_dc_spanning_tree_table_add_with_set_stp_state(
      g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
...
p4_pd_status_t switch_pd_spanning_tree_table_update_entry(
  ...
  status = p4_pd_dc_spanning_tree_table_modify_with_set_stp_state(
      g_sess_hdl, device, entry_hdl, &action_spec);
#endif /* P4_L2_DISABLE && P4_STP_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_urpf_bd_table_add_entry(switch_device_t device,
  ...
  status = p4_pd_dc_urpf_bd_table_add_with_nop(
      g_sess_hdl, p4_pd_device, &match_spec, entry_hdl);
...
p4_pd_status_t switch_pd_urpf_delete_entry(switch_device_t device,
  ...
  if (ip_addr->type == SWITCH_API_IP_ADDR_V4) {
    ...
    host_entry =
        (ip_addr->prefix_len == SWITCH_IPV4_PREFIX_LENGTH) ? TRUE : FALSE;
    if (host_entry) {
      status = p4_pd_dc_ipv4_urpf_table_delete(g_sess_hdl, device, entry_hdl);
    } else {
      status =
          p4_pd_dc_ipv4_urpf_lpm_table_delete(g_sess_hdl, device, entry_hdl);
    }
#endif /* P4_IPV4_DISABLE */
  } else {
#ifndef P4_IPV6_DISABLE
    host_entry =
        (ip_addr->prefix_len == SWITCH_IPV6_PREFIX_LENGTH) ? TRUE : FALSE;
    if (host_entry) {
      status = p4_pd_dc_ipv6_urpf_table_delete(g_sess_hdl, device, entry_hdl);
    } else {
      status =
          p4_pd_dc_ipv6_urpf_lpm_table_delete(g_sess_hdl, device, entry_hdl);
    }
#endif /* P4_IPV6_DISABLE */
  }
#endif /* P4_L3_DISABLE && P4_URPF_DISABLE */
...
p4_pd_status_t switch_pd_mcast_mgrp_tree_create(
  ...
  status = p4_pd_mc_mgrp_create(
      g_mc_sess_hdl, p4_pd_device.device_id, mgid_index, &mcast_info->mgrp_hdl);
...
p4_pd_status_t switch_pd_mcast_add_entry(switch_device_t device,
  ...
  p4_pd_status_t status = 0;
#ifndef P4_MULTICAST_DISABLE
  status = p4_pd_mc_node_create(g_mc_sess_hdl,
                                device,
...
p4_pd_status_t switch_pd_mcast_delete_entry(switch_device_t device,
  ...
  UNUSED(device);
#ifndef P4_MULTICAST_DISABLE
  status = p4_pd_mc_node_destroy(
      g_mc_sess_hdl, device, SWITCH_MCAST_NODE_INFO_HW_ENTRY(node));
...
p4_pd_status_t switch_pd_mcast_mgid_table_add_entry(switch_device_t device,
  ...
  p4_pd_status_t status = 0;
#ifndef P4_MULTICAST_DISABLE
  status = p4_pd_mc_associate_node(g_mc_sess_hdl,
                                   device,
                                   mgid_hdl,
                                   SWITCH_MCAST_NODE_INFO_HW_ENTRY(node),
                                   0,
...
p4_pd_status_t switch_pd_mcast_mgid_table_delete_entry(
  ...
  UNUSED(device);
#ifndef P4_MULTICAST_DISABLE
  status = p4_pd_mc_dissociate_node(
      g_mc_sess_hdl, device, mgid_hdl, SWITCH_MCAST_NODE_INFO_HW_ENTRY(node));
  p4_pd_mc_complete_operations(g_mc_sess_hdl);
#endif /* P4_MULTICAST_DISABLE */
  return status;
}
...
#ifndef P4_MULTICAST_DISABLE
  status =
      p4_pd_mc_set_lag_membership(g_mc_sess_hdl, device, lag_index, port_map);
  p4_pd_mc_complete_operations(g_mc_sess_hdl);
#endif /* P4_MULTICAST_DISABLE */
  return status;
}
...
p4_pd_status_t switch_pd_system_acl_table_add_entry(
  ...
  if (opt_action_params) {
    ...
    meter_id = handle_to_id(opt_action_params->meter_handle);
  }
  ...
  for (i = 0; i < count; i++) {
    switch (system_acl[i].field) {
      ...
      case SWITCH_ACL_SYSTEM_FIELD_CONTROL_FRAME:
        match_spec.ingress_metadata_control_frame =
            system_acl[i].value.control_frame;
        match_spec.ingress_metadata_control_frame_mask =
            system_acl[i].mask.u.mask & 0x1;
        break;
  ...
  switch (action_type) {
    ...
    case SWITCH_ACL_ACTION_REDIRECT_TO_CPU: {
      if (copy_only) {
        ...
        status =
            p4_pd_dc_system_acl_table_add_with_redirect_to_cpu(g_sess_hdl,
                                                               p4_pd_device,
                                                               &match_spec,
                                                               priority,
                                                               &action_spec,
        ...
        action_spec.action_icos = icos;
        action_spec.action_meter_id = meter_id;
        status = p4_pd_dc_system_acl_table_add_with_redirect_to_cpu_with_reason(
            g_sess_hdl,
            p4_pd_device,
            &match_spec,
            priority,
    ...
    case SWITCH_ACL_ACTION_COPY_TO_CPU: {
      if (copy_only) {
        ...
        memset(&action_spec,
               0,
               sizeof(p4_pd_dc_copy_to_cpu_with_reason_action_spec_t));
        action_spec.action_reason_code =
            action_params->cpu_redirect.reason_code;
        action_spec.action_qid = queue_id;
        action_spec.action_icos = icos;
    ...
    case SWITCH_ACL_ACTION_NEGATIVE_MIRROR:
      ...
      if (action_params->drop.reason_code) {
        p4_pd_dc_negative_mirror_with_reason_action_spec_t action_spec;
        memset(&action_spec,
               0,
               sizeof(p4_pd_dc_negative_mirror_with_reason_action_spec_t));
        action_spec.action_drop_reason = action_params->drop.reason_code;
        status = p4_pd_dc_system_acl_table_add_with_negative_mirror_with_reason(
            g_sess_hdl,
            p4_pd_device,
            &match_spec,
            priority,
...
static switch_tunnel_type_ingress_t switch_pd_get_mpls_tunnel_type(
    ...
    case SWITCH_API_MPLS_TERMINATE: {
      switch (mpls_encap->mpls_type) {
        case SWITCH_API_MPLS_TYPE_EOMPLS: {
          ...
          memset(
              &action_spec, 0, sizeof(p4_pd_dc_terminate_eompls_action_spec_t));
        ...
        case SWITCH_API_MPLS_TYPE_VPLS: {
          ...
          memset(
              &action_spec, 0, sizeof(p4_pd_dc_terminate_vpls_action_spec_t));
          // TODO: This is a hack. Eompls will work only when the inner packet
          // is IPV4.
          // This is just to avoid programming 3 entries - v4, v6 and non-ip.
          // Ideally, irrespective of inner header, eompls has to terminate but
        ...
        case SWITCH_API_MPLS_TYPE_IPV4_MPLS: {
          ...
          memset(&action_spec,
                 0,
                 sizeof(p4_pd_dc_terminate_ipv4_over_mpls_action_spec_t));
          match_spec.inner_ipv4_valid = TRUE;
          match_spec.inner_ipv6_valid = FALSE;
        ...
        case SWITCH_API_MPLS_TYPE_IPV6_MPLS: {
          ...
          memset(&action_spec,
                 0,
                 sizeof(p4_pd_dc_terminate_ipv6_over_mpls_action_spec_t));
          match_spec.inner_ipv4_valid = FALSE;
          match_spec.inner_ipv6_valid = TRUE;
          action_spec.action_vrf = handle_to_id(mpls_encap->vrf_handle);
          action_spec.action_tunnel_type =
...
p4_pd_status_t switch_pd_tunnel_rewrite_table_mpls_add_entry(
  ...
  switch (header_count) {
    case 1: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_rewrite_push1_action_spec_t));
      action_spec.action_smac_idx = smac_index;
      action_spec.action_dmac_idx = dmac_index;
      ...
      status = p4_pd_dc_tunnel_rewrite_table_add_with_set_mpls_rewrite_push1(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
    case 2: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_rewrite_push2_action_spec_t));
      action_spec.action_smac_idx = smac_index;
      action_spec.action_dmac_idx = dmac_index;
      action_spec.action_label1 = mpls_stack[0].label;
      action_spec.action_ttl1 = mpls_stack[0].ttl;
      ...
      status = p4_pd_dc_tunnel_rewrite_table_add_with_set_mpls_rewrite_push2(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
    case 3: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_rewrite_push3_action_spec_t));
      action_spec.action_smac_idx = smac_index;
      action_spec.action_dmac_idx = dmac_index;
      action_spec.action_label1 = mpls_stack[0].label;
      action_spec.action_ttl1 = mpls_stack[0].ttl;
      ...
      status = p4_pd_dc_tunnel_rewrite_table_add_with_set_mpls_rewrite_push3(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
    default:
      status = SWITCH_STATUS_INVALID_ENCAP_TYPE;
...
p4_pd_status_t switch_pd_rewrite_table_mpls_rewrite_add_entry(
  ...
  switch (neigh_type) {
    case SWITCH_API_NEIGHBOR_MPLS_PUSH_L2VPN: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_push_rewrite_l2_action_spec_t));
      action_spec.action_tunnel_index = tunnel_index;
      action_spec.action_header_count = header_count;
      status = p4_pd_dc_rewrite_table_add_with_set_mpls_push_rewrite_l2(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
    case SWITCH_API_NEIGHBOR_MPLS_PUSH_L3VPN: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_push_rewrite_l3_action_spec_t));
      action_spec.action_bd = bd;
      action_spec.action_tunnel_index = tunnel_index;
      action_spec.action_header_count = header_count;
      memcpy(action_spec.action_dmac, &dmac, ETH_LEN);
      status = p4_pd_dc_rewrite_table_add_with_set_mpls_push_rewrite_l3(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
    case SWITCH_API_NEIGHBOR_MPLS_SWAP_PUSH_L2VPN: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_swap_push_rewrite_l2_action_spec_t));
      action_spec.action_label = label;
      action_spec.action_tunnel_index = tunnel_index;
      action_spec.action_header_count = header_count;
      status = p4_pd_dc_rewrite_table_add_with_set_mpls_swap_push_rewrite_l2(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
    case SWITCH_API_NEIGHBOR_MPLS_SWAP_PUSH_L3VPN: {
      ...
      memset(&action_spec,
             0,
             sizeof(p4_pd_dc_set_mpls_swap_push_rewrite_l3_action_spec_t));
      action_spec.action_bd = bd;
      action_spec.action_label = label;
      action_spec.action_tunnel_index = tunnel_index;
      action_spec.action_header_count = header_count;
      memcpy(action_spec.action_dmac, &dmac, ETH_LEN);
      status = p4_pd_dc_rewrite_table_add_with_set_mpls_swap_push_rewrite_l3(
          g_sess_hdl, p4_pd_device, &match_spec, &action_spec, entry_hdl);
    } break;
...
p4_pd_status_t switch_pd_ipv4_acl_table_add_entry(
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      status = p4_pd_dc_ip_acl_table_add_with_acl_deny(g_sess_hdl,
                                                       p4_pd_device,
                                                       &match_spec,
                                                       priority,
                                                       &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      status = p4_pd_dc_ip_acl_table_add_with_acl_permit(g_sess_hdl,
                                                         p4_pd_device,
                                                         &match_spec,
                                                         priority,
                                                         &action_spec,
    ...
    case SWITCH_ACL_ACTION_REDIRECT: {
      ...
      if (switch_handle_get_type(handle) == SWITCH_HANDLE_TYPE_NHOP) {
        ...
        p4_pd_dc_ip_acl_table_add_with_acl_redirect_nexthop(g_sess_hdl,
                                                            p4_pd_device,
                                                            &match_spec,
                                                            priority,
                                                            &action_spec,
    ...
    case SWITCH_ACL_ACTION_SET_MIRROR: {
      ...
      status = p4_pd_dc_ip_acl_table_add_with_acl_mirror(g_sess_hdl,
                                                         p4_pd_device,
                                                         &match_spec,
                                                         priority,
                                                         &action_spec,
    ...
    case SWITCH_ACL_ACTION_REDIRECT_TO_CPU: {
      ...
      status = p4_pd_dc_ip_acl_table_add_with_acl_redirect_nexthop(g_sess_hdl,
                                                                   p4_pd_device,
                                                                   &match_spec,
                                                                   priority,
                                                                   &action_spec,
...
p4_pd_status_t switch_pd_egress_ipv4_acl_table_add_entry(
  ...
  if (if_label) {
    match_spec.acl_metadata_egress_if_label = if_label;
    match_spec.acl_metadata_egress_if_label_mask = 0xFFFF;
  }
  if (bd_label) {
    match_spec.acl_metadata_egress_bd_label = bd_label;
    match_spec.acl_metadata_egress_bd_label_mask = 0xFFFF;
  }
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      status =
          p4_pd_dc_egress_ip_acl_table_add_with_egress_acl_deny(g_sess_hdl,
                                                                p4_pd_device,
                                                                &match_spec,
                                                                priority,
                                                                &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      status =
          p4_pd_dc_egress_ip_acl_table_add_with_egress_acl_permit(g_sess_hdl,
                                                                  p4_pd_device,
                                                                  &match_spec,
                                                                  priority,
                                                                  &action_spec,
...
p4_pd_status_t switch_pd_ipv4_acl_table_delete_entry(
  ...
  if (direction == SWITCH_API_DIRECTION_INGRESS) {
    status = p4_pd_dc_ip_acl_table_delete(g_sess_hdl, device, entry_hdl);
  } else {
#ifdef P4_EGRESS_ACL_ENABLE
    status = p4_pd_dc_egress_ip_acl_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_EGRESS_ACL_ENABLE */
  }
...
p4_pd_status_t switch_pd_ipv6_acl_table_add_entry(
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      action_spec.action_acl_meter_index = meter_index;
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_ipv6_acl_table_add_with_acl_deny(g_sess_hdl,
                                                         p4_pd_device,
                                                         &match_spec,
                                                         priority,
                                                         &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      action_spec.action_acl_meter_index = meter_index;
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_ipv6_acl_table_add_with_acl_permit(g_sess_hdl,
                                                           p4_pd_device,
                                                           &match_spec,
                                                           priority,
                                                           &action_spec,
    ...
    case SWITCH_ACL_ACTION_REDIRECT: {
      ...
      if (switch_handle_get_type(handle) == SWITCH_HANDLE_TYPE_NHOP) {
        ...
        action_spec.action_nexthop_index = handle_to_id(handle);
        status =
            p4_pd_dc_ipv6_acl_table_add_with_acl_redirect_nexthop(g_sess_hdl,
                                                                  p4_pd_device,
                                                                  &match_spec,
                                                                  priority,
                                                                  &action_spec,
...
p4_pd_status_t switch_pd_egress_ipv6_acl_table_add_entry(
  ...
  for (i = 0; i < count; i++) {
    switch (ipv6_acl[i].field) {
      case SWITCH_ACL_IPV6_FIELD_IPV6_SRC:
        memcpy(
            match_spec.ipv6_srcAddr, ipv6_acl[i].value.ipv6_source.u.addr8, 16);
        memcpy(
            match_spec.ipv6_srcAddr_mask, ipv6_acl[i].mask.u.mask.u.addr8, 16);
        break;
      case SWITCH_ACL_IPV6_FIELD_IPV6_DEST:
        memcpy(
            match_spec.ipv6_dstAddr, ipv6_acl[i].value.ipv6_dest.u.addr8, 16);
        memcpy(
            match_spec.ipv6_dstAddr_mask, ipv6_acl[i].mask.u.mask.u.addr8, 16);
        break;
      case SWITCH_ACL_IPV6_FIELD_IP_PROTO:
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      status =
          p4_pd_dc_egress_ipv6_acl_table_add_with_egress_acl_deny(g_sess_hdl,
                                                                  p4_pd_device,
                                                                  &match_spec,
                                                                  priority,
                                                                  &action_spec,
...
#if !defined(P4_IPV6_DISABLE) && !defined(P4_ACL_DISABLE)
  if (direction == SWITCH_API_DIRECTION_INGRESS) {
    status = p4_pd_dc_ipv6_acl_table_delete(g_sess_hdl, device, entry_hdl);
  } else {
#ifdef P4_EGRESS_ACL_ENABLE
    status =
        p4_pd_dc_egress_ipv6_acl_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_EGRESS_ACL_ENABLE */
  }
#endif /* P4_IPV6_DISABLE & P4_ACL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_ipv4_racl_table_add_entry(
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      memset(&action_spec, 0, sizeof(action_spec));
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_ipv4_racl_table_add_with_racl_deny(g_sess_hdl,
                                                           p4_pd_device,
                                                           &match_spec,
                                                           priority,
                                                           &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_ipv4_racl_table_add_with_racl_permit(g_sess_hdl,
                                                             p4_pd_device,
                                                             &match_spec,
                                                             priority,
                                                             &action_spec,
    ...
    case SWITCH_ACL_ACTION_REDIRECT_TO_CPU: {
      ...
      action_spec.action_nexthop_index =
          switch_api_cpu_nhop_get(SWITCH_HOSTIF_REASON_CODE_GLEAN);
      status =
          p4_pd_dc_ipv4_racl_table_add_with_racl_redirect_nexthop(g_sess_hdl,
                                                                  p4_pd_device,
                                                                  &match_spec,
                                                                  priority,
                                                                  &action_spec,
...
p4_pd_status_t switch_pd_ipv6_racl_table_add_entry(
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      memset(&action_spec, 0, sizeof(action_spec));
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_ipv6_racl_table_add_with_racl_deny(g_sess_hdl,
                                                           p4_pd_device,
                                                           &match_spec,
                                                           priority,
                                                           &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_ipv6_racl_table_add_with_racl_permit(g_sess_hdl,
                                                             p4_pd_device,
                                                             &match_spec,
                                                             priority,
                                                             &action_spec,
    ...
    case SWITCH_ACL_ACTION_REDIRECT: {
      ...
      if (switch_handle_get_type(handle) == SWITCH_HANDLE_TYPE_NHOP) {
        ...
        action_spec.action_acl_stats_index = stats_index;
        action_spec.action_nexthop_index = handle_to_id(handle);
        p4_pd_dc_ipv6_racl_table_add_with_racl_redirect_nexthop(g_sess_hdl,
                                                                p4_pd_device,
                                                                &match_spec,
                                                                priority,
                                                                &action_spec,
...
p4_pd_status_t switch_pd_mac_acl_table_add_entry(
  ...
  for (i = 0; i < count; i++) {
    switch (mac_acl[i].field) {
      ...
      case SWITCH_ACL_MAC_FIELD_SOURCE_MAC:
        memcpy(match_spec.l2_metadata_lkp_mac_sa,
               mac_acl[i].value.source_mac.mac_addr,
               ETH_LEN);
        memcpy(match_spec.l2_metadata_lkp_mac_sa_mask,
               &mac_acl[i].mask.u.mask,
               ETH_LEN);
        break;
      case SWITCH_ACL_MAC_FIELD_DEST_MAC:
        memcpy(match_spec.l2_metadata_lkp_mac_da,
               mac_acl[i].value.dest_mac.mac_addr,
               ETH_LEN);
        memcpy(match_spec.l2_metadata_lkp_mac_da_mask,
               &mac_acl[i].mask.u.mask,
               ETH_LEN);
        break;
      default:
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      action_spec.action_acl_meter_index = meter_index;
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_mac_acl_table_add_with_acl_deny(g_sess_hdl,
                                                        p4_pd_device,
                                                        &match_spec,
                                                        priority,
                                                        &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      action_spec.action_acl_meter_index = meter_index;
      action_spec.action_acl_stats_index = stats_index;
      status = p4_pd_dc_mac_acl_table_add_with_acl_permit(g_sess_hdl,
                                                          p4_pd_device,
                                                          &match_spec,
                                                          priority,
                                                          &action_spec,
    ...
    case SWITCH_ACL_ACTION_REDIRECT_TO_CPU: {
      ...
      action_spec.action_nexthop_index =
          switch_api_cpu_nhop_get(SWITCH_HOSTIF_REASON_CODE_GLEAN);
      p4_pd_dc_mac_acl_table_add_with_acl_redirect_nexthop(g_sess_hdl,
                                                           p4_pd_device,
                                                           &match_spec,
                                                           priority,
                                                           &action_spec,
  ...
  for (i = 0; i < count; i++) {
    switch (mac_acl[i].field) {
      case SWITCH_ACL_MAC_FIELD_ETH_TYPE:
        ...
        break;
      case SWITCH_ACL_MAC_FIELD_SOURCE_MAC:
        memcpy(match_spec.ethernet_srcAddr,
               mac_acl[i].value.source_mac.mac_addr,
               ETH_LEN);
        memcpy(
            match_spec.ethernet_srcAddr_mask, &mac_acl[i].mask.u.mask, ETH_LEN);
        break;
      case SWITCH_ACL_MAC_FIELD_DEST_MAC:
        memcpy(match_spec.ethernet_dstAddr,
               mac_acl[i].value.dest_mac.mac_addr,
               ETH_LEN);
        memcpy(
            match_spec.ethernet_dstAddr_mask, &mac_acl[i].mask.u.mask, ETH_LEN);
        break;
      default:
        break;
    }
  ...
  switch (action) {
    case SWITCH_ACL_ACTION_DROP: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      status =
          p4_pd_dc_egress_mac_acl_table_add_with_egress_acl_deny(g_sess_hdl,
                                                                 p4_pd_device,
                                                                 &match_spec,
                                                                 priority,
                                                                 &action_spec,
    ...
    case SWITCH_ACL_ACTION_PERMIT: {
      ...
      action_spec.action_acl_copy_reason =
          action_params->cpu_redirect.reason_code;
      status =
          p4_pd_dc_egress_mac_acl_table_add_with_egress_acl_permit(g_sess_hdl,
                                                                   p4_pd_device,
                                                                   &match_spec,
                                                                   priority,
                                                                   &action_spec,
...
#if !defined(P4_L2_DISABLE) && !defined(P4_ACL_DISABLE)
  if (direction == SWITCH_API_DIRECTION_INGRESS) {
    status = p4_pd_dc_mac_acl_table_delete(g_sess_hdl, device, entry_hdl);
  } else {
#ifdef P4_EGRESS_ACL_ENABLE
    status =
        p4_pd_dc_egress_mac_acl_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_EGRESS_ACL_ENABLE */
  }
#endif /* P4_L2_DISABLE & P4_ACL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_egr_acl_table_add_entry(
  ...
  memset(&match_spec, 0, sizeof(p4_pd_dc_egress_system_acl_match_spec_t));
  for (i = 0; i < count; i++) {
  ...
  switch (action) {
    case SWITCH_ACL_EGR_ACTION_PERMIT: {
      status = p4_pd_dc_egress_system_acl_table_add_with_nop(
          g_sess_hdl, p4_pd_device, &match_spec, priority, entry_hdl);
    } break;
    case SWITCH_ACL_EGR_ACTION_DROP: {
    ...
    case SWITCH_ACL_EGR_ACTION_SET_MIRROR: {
      ...
      action_spec.action_session_id =
          handle_to_id(opt_action_params->mirror_handle);
      status =
          p4_pd_dc_egress_system_acl_table_add_with_egress_mirror(g_sess_hdl,
                                                                  p4_pd_device,
                                                                  &match_spec,
                                                                  priority,
                                                                  &action_spec,
...
#ifndef P4_ACL_DISABLE
  status =
      p4_pd_dc_egress_system_acl_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
#endif /* P4_ACL_DISABLE */
  return status;
}

p4_pd_status_t switch_pd_ingress_fabric_table_add_entry(
    switch_device_t device) {
  p4_pd_status_t status = 0;
  p4_pd_dev_target_t p4_pd_device;
...
p4_pd_status_t switch_pd_validate_outer_ethernet_add_default_entry(
  ...
  status =
      p4_pd_dc_validate_outer_ethernet_set_default_action_malformed_outer_ethernet_packet(
          g_sess_hdl, p4_pd_device, &action_spec, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_validate_outer_ip_add_default_entry(
  ...
  memset(
      &match_spec, 0, sizeof(p4_pd_dc_validate_outer_ipv4_packet_match_spec_t));
  memset(&action_spec,
         0,
         sizeof(p4_pd_dc_set_malformed_outer_ipv4_packet_action_spec_t));
  ...
  status =
      p4_pd_dc_validate_outer_ipv4_packet_table_add_with_set_valid_outer_ipv4_packet(
          g_sess_hdl, p4_pd_device, &match_spec, 13, &entry_hdl);
  ...
  status =
      p4_pd_dc_validate_outer_ipv4_packet_table_add_with_set_malformed_outer_ipv4_packet(
          g_sess_hdl, p4_pd_device, &match_spec, 14, &action_spec, &entry_hdl);
#endif /* P4_IPV4_DISABLE */
  ...
  status =
      p4_pd_dc_validate_outer_ipv6_packet_set_default_action_set_malformed_outer_ipv6_packet(
          g_sess_hdl, p4_pd_device, &v6_action_spec, &entry_hdl);

  /* ipv6 src is multicast */
  memset(&v6_match_spec,
         0,
  ...
  status =
      p4_pd_dc_validate_outer_ipv6_packet_table_add_with_set_valid_outer_ipv6_packet(
          g_sess_hdl, p4_pd_device, &v6_match_spec, 13, &entry_hdl);
...
p4_pd_status_t switch_pd_outer_rmac_table_add_default_entry(
  ...
  status = p4_pd_dc_outer_rmac_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_TUNNEL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
#ifndef P4_IPV4_DISABLE
  status = p4_pd_dc_ipv4_src_vtep_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV4_DISABLE */
#ifndef P4_IPV6_DISABLE
  status = p4_pd_dc_ipv6_src_vtep_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV6_DISABLE */
...
#ifndef P4_IPV4_DISABLE
  status = p4_pd_dc_ipv4_dest_vtep_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV4_DISABLE */
#ifndef P4_IPV6_DISABLE
  status = p4_pd_dc_ipv6_dest_vtep_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV6_DISABLE */
...
p4_pd_status_t switch_pd_tunnel_smac_rewrite_table_add_default_entry(
  ...
  status = p4_pd_dc_tunnel_smac_rewrite_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
...
p4_pd_status_t switch_pd_tunnel_dmac_rewrite_table_add_default_entry(
  ...
  status = p4_pd_dc_tunnel_dmac_rewrite_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
...
p4_pd_status_t switch_pd_tunnel_rewrite_table_add_default_entry(
  ...
  status = p4_pd_dc_tunnel_rewrite_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
...
p4_pd_status_t switch_pd_port_vlan_mapping_table_add_default_entry(
  ...
  status = p4_pd_dc_port_vlan_mapping_set_default_entry(
      g_sess_hdl, p4_pd_device, mbr_hdl, &entry_hdl);
...
p4_pd_status_t switch_pd_validate_packet_table_add_default_entry(
  ...
  status = p4_pd_dc_validate_packet_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  ...
  memset(&action_spec, 0, sizeof(p4_pd_dc_set_malformed_packet_action_spec_t));
  action_spec.action_drop_reason = DROP_SRC_MAC_ZERO;
  status =
      p4_pd_dc_validate_packet_table_add_with_set_malformed_packet(g_sess_hdl,
                                                                   p4_pd_device,
                                                                   &match_spec,
                                                                   priority++,
                                                                   &action_spec,
  ...
  for (i = 0; i < 16; i++) {
    ...
    memset(
        &action_spec, 0, sizeof(p4_pd_dc_set_malformed_packet_action_spec_t));
...
p4_pd_status_t switch_pd_acl_table_add_default_entry(switch_device_t device) {
  ...
  status = p4_pd_dc_system_acl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#ifndef P4_ACL_DISABLE
#ifndef P4_L2_DISABLE
  status = p4_pd_dc_mac_acl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_L2_DISABLE */

#ifndef P4_IPV4_DISABLE
  status = p4_pd_dc_ip_acl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);

  status = p4_pd_dc_ipv4_racl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);

#endif /* P4_IPV4_DISABLE */
#ifndef P4_IPV6_DISABLE
  status = p4_pd_dc_ipv6_acl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);

  status = p4_pd_dc_ipv6_racl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV6_DISABLE */
#endif /* P4_ACL_DISABLE */
...
switch_status_t switch_pd_inner_rmac_table_add_default_entry(
  ...
  status = p4_pd_dc_rmac_set_default_action_rmac_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
switch_status_t switch_pd_fwd_result_table_add_default_entry(
  ...
  status = p4_pd_dc_fwd_result_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
switch_status_t switch_pd_nexthop_table_add_default_entry(
  ...
  status = p4_pd_dc_nexthop_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
switch_status_t switch_pd_lag_table_add_default_entry(switch_device_t device) {
  ...
  status = p4_pd_dc_lag_action_profile_add_member_with_set_lag_miss(
      g_sess_hdl, p4_pd_device, &mbr_hdl);

  status = p4_pd_dc_lag_group_set_default_entry(
      g_sess_hdl, p4_pd_device, mbr_hdl, &entry_hdl);
...
switch_status_t switch_pd_rid_table_add_default_entry(switch_device_t device) {
  ...
  status =
      p4_pd_dc_rid_set_default_action_nop(g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_MULTICAST_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
switch_status_t switch_pd_replica_type_table_add_default_entry(
  ...
  status = p4_pd_dc_replica_type_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_MULTICAST_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
switch_status_t switch_pd_mac_table_add_default_entry(switch_device_t device) {
  ...
  status = p4_pd_dc_smac_set_default_action_smac_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  status = p4_pd_dc_dmac_set_default_action_dmac_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_L2_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
switch_status_t switch_pd_egress_vni_table_add_default_entry(
  ...
  status = p4_pd_dc_egress_vni_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_TUNNEL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
#ifndef P4_IPV4_DISABLE
  status = p4_pd_dc_ipv4_fib_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  status = p4_pd_dc_ipv4_fib_lpm_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV4_DISABLE */
#ifndef P4_IPV6_DISABLE
  status = p4_pd_dc_ipv6_fib_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  status = p4_pd_dc_ipv6_fib_lpm_set_default_action_on_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_IPV6_DISABLE */
#endif /* P4_L3_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_egress_vlan_xlate_table_add_default_entry(
  ...
  status =
      p4_pd_dc_egress_vlan_xlate_set_default_action_set_egress_packet_vlan_untagged(
          g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_egress_acl_add_default_entry(switch_device_t device) {
  ...
  status = p4_pd_dc_egress_system_acl_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_ACL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_vlan_decap_table_add_default_entry(
  ...
  status = p4_pd_dc_vlan_decap_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_tunnel_src_rewrite_table_add_default_entry(
  ...
  status = p4_pd_dc_tunnel_src_rewrite_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_tunnel_dst_rewrite_table_add_default_entry(
  ...
  status = p4_pd_dc_tunnel_dst_rewrite_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_TUNNEL_DISABLE || P4_MIRROR_DISABLE*/
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_adjust_lkp_fields_table_add_default_entry(
  ...
  status = p4_pd_dc_adjust_lkp_fields_set_default_action_non_ip_lkp(
      g_sess_hdl, p4_pd_device, &entry_hdl);

  p4_pd_dc_adjust_lkp_fields_match_spec_t match_spec;
  memset(&match_spec, 0, sizeof(match_spec));
  match_spec.ipv4_valid = true;
  status = p4_pd_dc_adjust_lkp_fields_table_add_with_ipv4_lkp(
      g_sess_hdl, p4_pd_device, &match_spec, &entry_hdl);

#ifndef P4_IPV6_DISABLE
  memset(&match_spec, 0, sizeof(match_spec));
  match_spec.ipv6_valid = true;
  status = p4_pd_dc_adjust_lkp_fields_table_add_with_ipv6_lkp(
      g_sess_hdl, p4_pd_device, &match_spec, &entry_hdl);
#endif
...
p4_pd_status_t switch_pd_tunnel_table_add_default_entry(
    switch_device_t device) {
  p4_pd_status_t status = 0;
#ifndef P4_TUNNEL_DISABLE
  p4_pd_entry_hdl_t entry_hdl;
  ...
  status = p4_pd_dc_tunnel_set_default_action_tunnel_lookup_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  status = p4_pd_dc_tunnel_lookup_miss_set_default_action_non_ip_lkp(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  ...
  while (tunnel_type <= SWITCH_INGRESS_TUNNEL_TYPE_MPLS_L3VPN_NUM_LABELS_3) {
    ...
    status = p4_pd_dc_tunnel_table_add_with_nop(
        g_sess_hdl, p4_pd_device, &match_spec, &entry_hdl);
    match_spec.tunnel_metadata_tunnel_vni = 0;
    match_spec.tunnel_metadata_ingress_tunnel_type = tunnel_type;
  ...
  status = p4_pd_dc_tunnel_lookup_miss_table_add_with_ipv4_lkp(
      g_sess_hdl, p4_pd_device, &match1_spec, &entry_hdl);

#ifndef P4_IPV6_DISABLE
  memset(&match1_spec, 0, sizeof(match1_spec));
  match1_spec.ipv6_valid = true;
  status = p4_pd_dc_tunnel_lookup_miss_table_add_with_ipv6_lkp(
      g_sess_hdl, p4_pd_device, &match1_spec, &entry_hdl);
#endif
...
p4_pd_status_t switch_pd_bd_flood_table_add_default_entry(
  ...
  status = p4_pd_dc_bd_flood_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
...
p4_pd_status_t switch_pd_fwd_result_table_add_init_entry(
  ...
  status = p4_pd_dc_fwd_result_table_add_with_set_nat_redirect_action(
      g_sess_hdl, p4_pd_device, &match_spec, prio++, &entry_hdl);
...
p4_pd_status_t switch_pd_learn_notify_table_add_init_entry(
  ...
  // add default entry
  status = p4_pd_dc_learn_notify_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  ...
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 900, &entry_hdl);
  ...
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 901, &entry_hdl);
  ...
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 902, &entry_hdl);
  ...
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 903, &entry_hdl);
  ...
  match_spec.l2_metadata_stp_state = SWITCH_PORT_STP_STATE_NONE;
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_nop(
  ...
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 1003, &entry_hdl);
  ...
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_nop(
      g_sess_hdl, p4_pd_device, &match_spec, 1004, &entry_hdl);
  memset(&match_spec, 0, sizeof(match_spec));
  match_spec.l2_metadata_stp_state = SWITCH_PORT_STP_STATE_LEARNING;
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 1005, &entry_hdl);
  ...
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_nop(
      g_sess_hdl, p4_pd_device, &match_spec, 1006, &entry_hdl);
  memset(&match_spec, 0, sizeof(match_spec));
  match_spec.l2_metadata_stp_state = SWITCH_PORT_STP_STATE_FORWARDING;
  match_spec.l2_metadata_stp_state_mask = 0xF;
  status = p4_pd_dc_learn_notify_table_add_with_generate_learn_notify(
      g_sess_hdl, p4_pd_device, &match_spec, 1007, &entry_hdl);
...
p4_pd_status_t switch_pd_validate_outer_ethernet_table_init_entry(
  ...
  memset(&action_spec,
         0,
         sizeof(p4_pd_dc_malformed_outer_ethernet_packet_action_spec_t));
  memset(match_spec.ethernet_srcAddr_mask,
         0xff,
  ...
  memset(&action_spec,
         0,
         sizeof(p4_pd_dc_malformed_outer_ethernet_packet_action_spec_t));
  memset(match_spec.ethernet_dstAddr_mask,
         0xff,
...
p4_pd_status_t switch_pd_fabric_header_table_init_entry(
    switch_device_t device) {
  p4_pd_status_t status = 0;
#ifdef FABRIC_ENABLE
  p4_pd_entry_hdl_t entry_hdl;
  ...
  status = p4_pd_dc_fabric_lag_action_profile_add_member_with_nop(
      g_sess_hdl, p4_pd_device, &mbr_hdl);
  status = p4_pd_dc_fabric_lag_set_default_entry(
      g_sess_hdl, p4_pd_device, mbr_hdl, &entry_hdl);
#endif /* FABRIC_ENABLE */
...
switch_status_t switch_pd_replica_type_table_init_entry(
    switch_device_t device) {
  p4_pd_status_t status = 0;
#ifndef P4_MULTICAST_DISABLE
  p4_pd_entry_hdl_t entry_hdl;
...
p4_pd_status_t switch_pd_bd_ingress_stats_get(switch_device_t device,
  ...
  for (index = 0; index < SWITCH_BD_STATS_OUT_UCAST; index++) {
    counter = p4_pd_dc_counter_read_ingress_bd_stats(g_sess_hdl,
                                                     p4_pd_device,
...
p4_pd_status_t switch_pd_bd_egress_stats_get(switch_device_t device,
  ...
  for (index = 0; index < 3; index++) {
    counter =
        p4_pd_dc_counter_read_egress_bd_stats(g_sess_hdl,
                                              p4_pd_device,
                                              bd_stats->stats_hw_entry[index],
                                              COUNTER_READ_HW_SYNC);
    bd_stats->counters[index + SWITCH_BD_STATS_OUT_UCAST].num_packets =
        counter.packets;
    bd_stats->counters[index + SWITCH_BD_STATS_OUT_UCAST].num_bytes =
        counter.bytes;
  }
#endif /* P4_STATS_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
...
p4_pd_status_t switch_pd_drop_stats_get(switch_device_t device,
  ...
  for (index = 0; index < num_counters; index++) {
    counter = p4_pd_dc_counter_read_drop_stats(
        g_sess_hdl, p4_pd_device, index, COUNTER_READ_HW_SYNC);
    *(counters + index) = counter.packets;
    counter = p4_pd_dc_counter_read_drop_stats_2(
        g_sess_hdl, p4_pd_device, index, COUNTER_READ_HW_SYNC);
    *(counters + index) += counter.packets;
  }
#endif /* P4_STATS_DISABLE */
...
p4_pd_status_t switch_pd_meter_stats_get(switch_device_t device,
  ...
  for (index = 0; index < SWITCH_COLOR_MAX; index++) {
    counter =
        p4_pd_dc_counter_read_meter_stats(g_sess_hdl,
                                          p4_pd_device,
...
#endif /* !P4_STATS_DISABLE && !P4_STATS_DISABLE */
...
p4_pd_status_t switch_pd_acl_stats_get(switch_device_t device,
  ...
  counter = p4_pd_dc_counter_read_acl_stats(
      g_sess_hdl, p4_pd_device, acl_stats_index, COUNTER_READ_HW_SYNC);
...
p4_pd_direction_t switch_pd_p4_pd_direction(switch_direction_t dir) {
  switch (dir) {
...
p4_pd_status_t switch_pd_mirror_session_delete(switch_device_t device,
  ...
  status = p4_pd_mirror_session_delete(
      g_sess_hdl, p4_pd_device, handle_to_id(mirror_handle));
...
p4_pd_status_t switch_pd_mirror_table_entry_add(
  ...
  switch (api_mirror_info->mirror_type) {
    ...
    case SWITCH_MIRROR_TYPE_REMOTE: {
      ...
      status =
          p4_pd_dc_mirror_table_add_with_set_mirror_bd(g_sess_hdl,
                                                       p4_pd_device,
                                                       &match_spec,
                                                       &action_spec,
                                                       &mirror_info->pd_hdl);
    ...
    case SWITCH_MIRROR_TYPE_ENHANCED_REMOTE: {
      ...
      status =
          p4_pd_dc_mirror_table_add_with_set_mirror_nhop(g_sess_hdl,
                                                         p4_pd_device,
                                                         &match_spec,
                                                         &action_spec,
                                                         &mirror_info->pd_hdl);
...
#if !defined(P4_MIRROR_DISABLE)
  status =
      p4_pd_dc_mirror_table_delete(g_sess_hdl, device, mirror_info->pd_hdl);
  p4_pd_complete_operations(g_sess_hdl);
#endif /* P4_MIRROR_DISABLE */
...
switch_status_t switch_pd_mirror_table_add_default_entry(
  ...
  status = p4_pd_dc_mirror_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
#endif /* P4_MIRROR_DISABLE */
...
switch_status_t switch_pd_mtu_table_add_ipv4_check(switch_device_t device,
  ...
  memset(&match_spec, 0, sizeof(p4_pd_dc_mtu_match_spec_t));
  match_spec.l3_metadata_mtu_index = mtu_index;
  match_spec.ipv4_valid = 1;
  match_spec.ipv6_valid = 0;

  memset(&action_spec, 0, sizeof(p4_pd_dc_ipv4_mtu_check_action_spec_t));
  action_spec.action_l3_mtu = mtu;

  status = p4_pd_dc_mtu_table_add_with_ipv4_mtu_check(
      g_sess_hdl, p4_pd_device, &match_spec, &action_spec, &entry_hdl);
...
switch_status_t switch_pd_mtu_table_add_ipv6_check(switch_device_t device,
  ...
  memset(&action_spec, 0, sizeof(p4_pd_dc_ipv6_mtu_check_action_spec_t));
  action_spec.action_l3_mtu = mtu;

  status = p4_pd_dc_mtu_table_add_with_ipv6_mtu_check(
      g_sess_hdl, p4_pd_device, &match_spec, &action_spec, &entry_hdl);
...
p4_pd_status_t switch_pd_mtu_table_delete_entry(switch_device_t device,
                                                p4_pd_entry_hdl_t entry_hdl) {
  p4_pd_status_t status = 0;
  status = p4_pd_dc_mtu_table_delete(g_sess_hdl, device, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
#ifndef P4_L3_DISABLE
  status = p4_pd_dc_mtu_set_default_action_mtu_miss(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_L3_DISABLE */
...
switch_status_t switch_pd_l3_rewrite_table_add_default_entry(
  ...
  status = p4_pd_dc_l3_rewrite_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif /* P4_L3_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
...
p4_pd_status_t switch_pd_int_transit_enable(switch_device_t device,
  ...
  (void)prio;  // remove
  status = p4_pd_dc_int_insert_table_add_with_int_transit(
...
p4_pd_status_t switch_pd_int_src_enable(switch_device_t device,
  ...
  insert_action_spec.action_ins_byte_cnt =
      (ins_cnt * 4) + 12;  // 12 for headers
  ...
  status = p4_pd_dc_int_source_table_add_with_int_set_src(
      g_sess_hdl, p4_pd_device, &src_match_spec, prio, entry_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
#endif
...
p4_pd_status_t switch_pd_int_sink_enable(switch_device_t device,
  ...
  status = p4_pd_dc_int_terminate_table_add_with_int_sink_gpe(
      g_sess_hdl, p4_pd_device, &match_spec, prio, &action_spec, entry_hdl);
  ...
  // headers
  {
    ...
    status =
        p4_pd_dc_int_sink_update_outer_table_add_with_int_sink_update_vxlan_gpe_v4(
            g_sess_hdl, p4_pd_device, &match_spec, entry_hdl);
  }
...
p4_pd_status_t switch_pd_int_tables_init(switch_device_t device) {
...
#ifdef P4_INT_EP_ENABLE
  // int_source Table
  p4_pd_dc_int_source_set_default_action_int_set_no_src(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  // int_terminate - default is no_terminate
  p4_pd_dc_int_terminate_set_default_action_int_no_sink(
      g_sess_hdl, p4_pd_device, &entry_hdl);

  // int_sink_update_outer
  p4_pd_dc_int_sink_update_outer_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#endif
  // int_insert - default :  do not insert INT information
  p4_pd_dc_int_insert_set_default_action_int_reset(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  ...
  p4_pd_dc_int_outer_encap_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
#ifdef P4_INT_TRANSIT_ENABLE
  {
    // Trasit
  ...
  p4_pd_dc_int_inst_0811_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_dc_int_inst_1215_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
  p4_pd_dc_int_bos_set_default_action_nop(g_sess_hdl, p4_pd_device, &entry_hdl);
  ...
  for (i = 0; i < 16; i++) {
    ...
    match_spec.int_header_instruction_mask_0003_mask = (mask >> 12) & 0xF;
    match_spec.int_header_instruction_mask_0407 = (key >> 8) & 0xF;
    match_spec.int_header_instruction_mask_0407_mask = (mask >> 8) & 0xF;
    match_spec.int_header_instruction_mask_0811 = (key >> 4) & 0xF;
    match_spec.int_header_instruction_mask_0811_mask = (mask >> 4) & 0xF;
    match_spec.int_header_instruction_mask_1215 = (key)&0xF;
    match_spec.int_header_instruction_mask_1215_mask = (mask)&0xF;

    switch (i) {
      case 0: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_0_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 1: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_1_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 2: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_2_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 3: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_3_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 4: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_4_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 5: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_5_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 6: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_6_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 7: {
        p4_pd_dc_int_bos_table_add_with_int_set_header_7_bos(
            g_sess_hdl, p4_pd_device, &match_spec, i, &entry_hdl);
        break;
      }
      case 8:
      ...
      default:
        ...
        p4_pd_dc_int_bos_table_add_with_nop(
            g_sess_hdl, p4_pd_device, &match_spec, 15, &entry_hdl);
        break;
    }
    key >>= 1;
    mask >>= 1;
...
p4_pd_status_t switch_pd_storm_control_meter_add_entry(
  ...
  if (api_meter_info->meter_type == SWITCH_METER_TYPE_BYTES) {
    ...
    status = p4_pd_dc_meter_set_storm_control_meter(
        g_sess_hdl, p4_pd_device, meter_idx, &meter_spec);
  } else {
...
p4_pd_status_t switch_pd_storm_control_table_add_entry(
  ...
  match_spec.l2_metadata_lkp_pkt_type_mask = 0xFF;
  match_spec.standard_metadata_ingress_port = port;

  action_spec.action_meter_idx = meter_idx;

  status = p4_pd_dc_storm_control_table_add_with_set_storm_control_meter(
      g_sess_hdl, p4_pd_device, &match_spec, priority, &action_spec, entry_hdl);
...
p4_pd_status_t switch_pd_storm_control_table_delete_entry(
  ...
  status = p4_pd_dc_storm_control_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* P4_METER_DISABLE && P4_STORM_CONTROL_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_meter_index_table_add_default_entry(
  ...
  status = p4_pd_dc_meter_index_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &meter_spec, &entry_hdl);
#endif /* METER_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
p4_pd_status_t switch_pd_meter_index_table_add_entry(
  ...
  if (api_meter_info->meter_type == SWITCH_METER_TYPE_BYTES) {
    ...
    status = p4_pd_dc_meter_index_table_add_with_nop(
        g_sess_hdl, p4_pd_device, &match_spec, &meter_spec, entry_hdl);
  } else {
    p4_pd_packets_meter_spec_t meter_spec;
    memset(&meter_spec, 0, sizeof(p4_pd_packets_meter_spec_t));
    meter_spec.cir_pps = api_meter_info->cir;
...
p4_pd_status_t switch_pd_meter_index_table_update_entry(
  ...
  if (api_meter_info->meter_type == SWITCH_METER_TYPE_BYTES) {
    ...
    status = p4_pd_dc_meter_index_table_modify_with_nop(
        g_sess_hdl, device, entry_hdl, &meter_spec);
  } else {
    p4_pd_packets_meter_spec_t meter_spec;
    memset(&meter_spec, 0, sizeof(p4_pd_bytes_meter_spec_t));
    meter_spec.cir_pps = api_meter_info->cir;
...
p4_pd_status_t switch_pd_meter_index_table_delete_entry(
  ...
  p4_pd_status_t status = 0;
#ifndef METER_DISABLE
  status = p4_pd_dc_meter_index_table_delete(g_sess_hdl, device, entry_hdl);
#endif /* METER_DISABLE */
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
    ...
    switch (api_meter_info->action[color]) {
      case SWITCH_ACL_ACTION_PERMIT:
        status = p4_pd_dc_meter_action_table_add_with_meter_permit(
            g_sess_hdl, p4_pd_device, &match_spec, &entry_hdl[color]);
        break;
      case SWITCH_ACL_ACTION_DROP:
    ...
    switch (api_meter_info->action[color]) {
      case SWITCH_ACL_ACTION_PERMIT:
        status = p4_pd_dc_meter_action_table_modify_with_meter_permit(
            g_sess_hdl, device, entry_hdl[color]);
        break;
      case SWITCH_ACL_ACTION_DROP:
...
switch_status_t switch_pd_switch_config_params_update(switch_device_t device) {
  ...
  status =
      p4_pd_dc_switch_config_params_set_default_action_set_config_parameters(
          g_sess_hdl, p4_pd_device, &cfg_action, &entry_hdl);
...
switch_status_t switch_pd_sflow_ingress_table_add(
  ...
  if (match_key->sip) {
    ...
    ingress_sflow_match.ipv4_metadata_lkp_ipv4_sa_mask = match_key->sip_mask;
  }
  if (match_key->dip) {
    ingress_sflow_match.ipv4_metadata_lkp_ipv4_da = match_key->dip;
    ingress_sflow_match.ipv4_metadata_lkp_ipv4_da_mask = match_key->dip_mask;
  }
  if (sample_rate == 0) {
...
static switch_status_t switch_pd_sflow_ingress_table_delete(
    switch_device_t device, switch_sflow_match_entry_t *match_entry) {
  switch_status_t status = SWITCH_STATUS_FAILURE;

  status = p4_pd_dc_sflow_ingress_table_delete(
      g_sess_hdl, device, match_entry->ingress_sflow_ent_hdl);
  p4_pd_complete_operations(g_sess_hdl);
  return status;
}
...
switch_status_t switch_pd_mirror_table_sflow_add(
  ...
  match_spec.i2e_metadata_mirror_session_id =
      handle_to_id(sflow_info->mirror_hdl);
...
switch_status_t switch_pd_sflow_session_create(
  ...
  if ((sflow_info->api_info.collector_type == SFLOW_COLLECTOR_TYPE_CPU) &&
    ...
    match_spec.ingress_metadata_sflow_take_sample_mask =
...
p4_pd_status_t switch_pd_stats_update(switch_device_t device) {
  ...
  status = p4_pd_dc_counter_hw_sync_storm_control_stats(
      g_sess_hdl, p4_pd_device, &switch_pd_stats_update_cb, NULL);
    ...
    if (api_meter_info->meter_type == SWITCH_METER_TYPE_BYTES) {
      ...
      meter_spec.meter_type =
          api_meter_info->color_source == SWITCH_METER_COLOR_SOURCE_BLIND
              ? PD_METER_TYPE_COLOR_UNAWARE
              : PD_METER_TYPE_COLOR_AWARE;
      status = p4_pd_dc_meter_set_copp(
          g_sess_hdl, p4_pd_device, meter_id, &meter_spec);
    }
  } else {
    if (api_meter_info->meter_type == SWITCH_METER_TYPE_BYTES) {
      p4_pd_bytes_meter_spec_t meter_spec;
...
p4_pd_status_t switch_pd_range_entry_delete(switch_device_t device,
  ...
  switch (range_type) {
    case SWITCH_RANGE_TYPE_SRC_PORT: {
      if (direction == SWITCH_API_DIRECTION_INGRESS) {
        status = p4_pd_dc_ingress_l4_src_port_table_delete(
            g_sess_hdl, device, entry_hdl);
      } else {
#ifdef P4_EGRESS_ACL_ENABLE
        status = p4_pd_dc_egress_l4_src_port_table_delete(
            g_sess_hdl, device, entry_hdl);
#endif /* P4_EGRESS_ACL_ENABLE */
      }
      break;
      ...
      case SWITCH_RANGE_TYPE_DST_PORT: {
        if (direction == SWITCH_API_DIRECTION_INGRESS) {
          status = p4_pd_dc_ingress_l4_dst_port_table_delete(
              g_sess_hdl, device, entry_hdl);
        } else {
#ifdef P4_EGRESS_ACL_ENABLE
          status = p4_pd_dc_egress_l4_dst_port_table_delete(
              g_sess_hdl, device, entry_hdl);
#endif /* P4_EGRESS_ACL_ENABLE */
        }
      } break;
...
p4_pd_status_t switch_pd_l4port_default_entry_add(switch_device_t device) {
  ...
  status = p4_pd_dc_ingress_l4_src_port_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);

  status = p4_pd_dc_ingress_l4_dst_port_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);

#ifdef P4_EGRESS_ACL_ENABLE
  status = p4_pd_dc_egress_l4_src_port_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);

  status = p4_pd_dc_egress_l4_dst_port_set_default_action_nop(
      g_sess_hdl, p4_pd_device, &entry_hdl);
