...
*/
typedef void (*switch_mac_learn_entry_notify_cb)(
...
typedef struct switch_mac_cb_fn_ {
  switch_mac_learn_entry_notify_cb
      mac_learn_notify_cb; /**< mac learn notification callback */
  switch_mac_aging_entry_notify_cb
      mac_aging_notify_cb; /**< mac aging notification callback */
} switch_mac_cb_fn_t;
...
*/
switch_status_t switch_api_mac_table_attribute_set(switch_mac_attr_t mac_attr,
                                                   uint64_t value);
...
/**
  ...
  @param value - value of the attribute
*/
switch_status_t switch_api_mac_table_attribute_get(switch_mac_attr_t mac_attr,
                                                   uint64_t *value);
 ...
 */
typedef switch_status_t (*switch_mac_table_iterator_fn)(
    switch_api_mac_entry_t *mac_entry);
...
/**
 ...
 @param iterator_fn - Iterator function
 */
switch_status_t switch_api_mac_table_entries_get_by_interface_vlan(
