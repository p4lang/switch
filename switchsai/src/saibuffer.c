...
sai_status_t sai_set_buffer_pool_attr(_In_ sai_object_id_t pool_id,
                                      _In_ const sai_attribute_t *attr) {
  return SAI_STATUS_SUCCESS;
}

sai_status_t sai_get_buffer_pool_attr(_In_ sai_object_id_t pool_id,
                                      _In_ uint32_t attr_count,
...
sai_status_t sai_set_buffer_profile_attr(_In_ sai_object_id_t buffer_profile_id,
                                         _In_ const sai_attribute_t *attr) {
  return SAI_STATUS_SUCCESS;
}

sai_status_t sai_get_buffer_profile_attr(_In_ sai_object_id_t buffer_profile_id,
                                         _In_ uint32_t attr_count,
                                         _Inout_ sai_attribute_t *attr_list) {
  return SAI_STATUS_SUCCESS;
}
